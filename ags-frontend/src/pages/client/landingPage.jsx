...
export default function LandingPage() {
    ...
    // Hero gallery images from public/imageser folder
    const heroImages = [
        "/images/image (6).jpg",
        "/images/image (7).jpg",
        "/images/image (8).jpg",
                        ...
                        <div className="relative hidden lg:block">
                            ...
                            <div className="relative w-full h-[620px]">
                                ...
                                <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
                                    <div className="absolute top-1/4 left-1/3 w-40 h-40 bg-accent/20 rounded-full blur-3xl animate-float"></div>
                                    <div className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-secondary/15 rounded-full blur-3xl animate-float-delayed"></div>
                                    <div className="absolute top-1/2 right-1/3 w-36 h-36 bg-muted/20 rounded-full blur-3xl animate-pulse"></div>
                                </div>

                                {/* Gallery Frame with Smooth Animations */}
                                <div className="relative w-full h-full rounded-[2rem] overflow-hidden shadow-[0_20px_70px_rgba(0,0,0,0.25)] hover:shadow-[0_25px_90px_rgba(0,0,0,0.35)] transition-all duration-700">
                                    
                                    {/* Image Stack with Crossfade Effect */}
                                    {heroImages.map((image, index) => (
                                        ...
                                        >
                                            ...
                                            <div className={`absolute inset-0 bg-gradient-to-t transition-opacity duration-1000 ${
                                                index === currentImageIndex
                                                    ? 'from-secondary/10 via-transparent to-transparent opacity-100'
                                                    : 'from-secondary/30 via-transparent to-transparent opacity-0'
                                            }`}></div>
                                        </div>
                                    ))}

                                    {/* Animated Border Pulse Effect */}
                                    <div className="absolute inset-0 border-[3px] border-accent/30 rounded-[2rem] pointer-events-none animate-pulse-glow"></div>
                                    
                                    {/* Elegant Corner Accents - Top Left */}
                                    <div className="absolute top-0 left-0 w-16 h-16 border-t-[3px] border-l-[3px] border-neutral/60 rounded-tl-[2rem] transition-all duration-500 hover:w-20 hover:h-20 hover:border-neutral/80"></div>
                                    
                                    {/* Elegant Corner Accents - Bottom Right */}
                                    <div className="absolute bottom-0 right-0 w-16 h-16 border-b-[3px] border-r-[3px] border-neutral/60 rounded-br-[2rem] transition-all duration-500 hover:w-20 hover:h-20 hover:border-neutral/80"></div>
                                    
                                    {/* Minimalist Dot Indicators - Bottom Center */}
                                        ...
                                        {heroImages.map((_, index) => (
                                            <button
                                                ...
                                                className={`transition-all duration-500 rounded-full ${
                                                    index === currentImageIndex 
                                                        ? 'w-10 h-2 bg-neutral shadow-lg' 
                                                        : 'w-2 h-2 bg-neutral/30 hover:bg-neutral/60 hover:w-3'
                                                }`}
                                    ...
                                    <div className="absolute top-1/4 right-12 w-2 h-2 bg-neutral/40 rounded-full animate-float shadow-lg"></div>
                                    <div className="absolute bottom-1/3 left-14 w-2 h-2 bg-neutral/40 rounded-full animate-float-delayed shadow-lg"></div>
                                    <div className="absolute top-2/3 right-1/4 w-1.5 h-1.5 bg-accent/50 rounded-full animate-pulse"></div>
                                </div>
